...
export const patients: Patient[] = [
  ...
  },
  {
    ...
    room: "ICU-3",
    ward: "ICU",
    diagnosis: "Acute MI — stable",
    admittedAt: "02 Jul · 22:40",
    doctor: "Dr. Iyer",
    billing: "Pending",
    totalBill: 385000,
    paid: 150000,
  ...
  },
  {
    ...
    room: "301",
    ward: "Private",
    diagnosis: "Dengue — recovering",
    admittedAt: "01 Jul · 14:00",
    doctor: "Dr. Rao",
    billing: "Outstanding",
    totalBill: 88000,
    paid: 20000,
  },
  {
    ...
    age: 63,
    gender: "F",
    phone: "+91 90003 22110",
    room: "ICU-1",
    ward: "ICU",
    diagnosis: "Sepsis",
    admittedAt: "30 Jun · 03:15",
    doctor: "Dr. Iyer",
    billing: "Pending",
    totalBill: 219000,
    paid: 90000,
  ...
  },
  {
    ...
    age: 71,
    gender: "M",
    phone: "+91 98444 90210",
    room: "—",
    ward: "Discharged",
    diagnosis: "Cataract",
    admittedAt: "01 Jul · 08:00",
    doctor: "Dr. Rao",
    billing: "Discharged — Pending",
    totalBill: 48000,
    paid: 20000,
    insurance: "Star Health",
  },
...
export const notices: Notice[] = [
  {
    id: "n1",
    title: "OT-2 closed tomorrow",
    body: "Operation Theatre 2 will remain closed all day for anaesthesia system maintenance. Please reschedule non-urgent cases.",
    tag: "OT",
    postedBy: "Director",
    postedAt: "Today · 08:12",
  },
  {
    id: "n2",
    title: "Free diabetes camp — Sunday",
    body: "Community medical camp in the atrium, 9 AM to 2 PM. Volunteers may sign up at Reception.",
    tag: "Camp",
    postedBy: "Reception",
    postedAt: "Yesterday",
  },
  {
    id: "n3",
    title: "Fire safety drill — Friday 11 AM",
    body: "Full evacuation drill. Ward-in-charge to coordinate patient movement. Please brief night shift.",
    tag: "Drill",
    postedBy: "Director",
    postedAt: "Yesterday",
  },
  {
    id: "n4",
    title: "NABH inspection — Monday",
    body: "Inspectors expected on-site by 10 AM. Please ensure department documentation is up to date.",
    tag: "Inspection",
    postedBy: "Director",
    postedAt: "2 days ago",
  },
...
export const calendarEvents: CalendarEvent[] = [
  {
    id: "e1",
    day: 4,
    title: "Angioplasty — Dr. Iyer",
    time: "10:00",
    location: "OT-1",
    description: "Elective. Patient: Rahul Menon (MSH-24020).",
    kind: "OT",
    createdBy: "Reception",
  },
  {
    id: "e2",
    day: 4,
    title: "OPD — Dr. Rao (Paediatrics)",
    time: "16:00 – 19:00",
    location: "OPD Block A",
    description: "Regular Wednesday clinic.",
    kind: "OPD",
    createdBy: "Director",
  },
  {
    id: "e3",
    day: 6,
    title: "Free diabetes camp",
    time: "09:00 – 14:00",
    location: "Atrium",
    description: "Community outreach. Volunteers welcome.",
    kind: "Camp",
    createdBy: "Director",
  },
  {
    id: "e4",
    day: 8,
    title: "MRI machine — annual service",
    time: "08:00",
    location: "Radiology",
    description: "Downtime expected until noon.",
    kind: "Maintenance",
    createdBy: "Director",
  },
  {
    id: "e5",
    day: 10,
    title: "Sister Anita — leave",
    time: "All day",
    location: "—",
    description: "Approved leave through Friday.",
    kind: "Leave",
    createdBy: "Reception",
  },
  {
    id: "e6",
    day: 10,
    title: "Laparoscopy — Dr. Rao",
    time: "11:30",
    location: "OT-3",
    description: "Case: Ananya Sharma follow-up.",
    kind: "OT",
    createdBy: "Reception",
  },
  {
  ...
  },
  {
    ...
    time: "09:00",
    location: "ICU",
    description: "Biomed preventive maintenance.",
    kind: "Maintenance",
    createdBy: "Director",
  },
  {
    id: "e9",
    day: 20,
    title: "Cardiac screening camp",
    time: "09:00 – 13:00",
    location: "Community Hall, T. Nagar",
    description: "Off-site screening.",
    kind: "Camp",
    createdBy: "Reception",
  },
  {
  ...
  },
  {
    id: "e11",
    day: 25,
    title: "Hip replacement — Dr. Bhat",
    time: "09:00",
    location: "OT-2",
    description: "Elective orthopaedic case.",
    kind: "OT",
    createdBy: "Reception",
  },
];
...
export const auditTrail: AuditEntry[] = [
  {
    ...
    user: "Priya Suresh",
    role: "receptionist",
    action: "Admitted patient Ananya Sharma to Room 204",
    at: "Today · 09:14",
  },
  {
    id: "a2",
    user: "Dr. Vinay Bhat",
    role: "rmo",
    action: "Updated vitals for MSH-24020",
    at: "Today · 09:02",
  },
  {
    id: "a3",
    user: "Neha Iyer",
    role: "tpa",
    action: "Uploaded pre-authorisation for claim CL-9822",
    at: "Today · 08:47",
  },
  {
    id: "a4",
    user: "Karthik Menon",
    role: "receptionist",
    action: "Discharged patient MSH-24011",
    at: "Today · 08:30",
  },
  {
    id: "a5",
    user: "Dr. Arvind Rao",
    role: "director",
    action: "Modified duty roster — Night shift",
    at: "Yesterday · 21:12",
  },
  {
    id: "a6",
    user: "Sister Anita",
    role: "sister",
    action: "Filed indent IND-441 (OT consumables)",
    at: "Yesterday · 18:20",
  },
  {
    id: "a7",
    user: "Dr. Arvind Rao",
    role: "director",
    action: "Created new employee record MS-N-052",
    at: "2 days ago",
  },
  {
    id: "a8",
    user: "Neha Iyer",
    role: "tpa",
    action: "Marked claim CL-9825 as Approved",
    at: "2 days ago",
  },
];
...
export const indents: Indent[] = [
  {
    ...
    priority: "Urgent",
    items: "Sterile gloves, IV sets, gauze packs",
    quantity: "20 · 10 · 15",
    status: "Approved",
    remarks: "For today's scheduled procedures",
    raisedBy: "Sister Anita",
    raisedAt: "Yesterday",
  },
  {
    id: "IND-442",
    department: "ICU",
    priority: "High",
    items: "Endotracheal tubes",
    quantity: "6",
    status: "Ordered",
    raisedBy: "Sister Meena",
    raisedAt: "Yesterday",
  },
  {
    id: "IND-443",
    ...
    quantity: "40",
    status: "Pending",
    raisedBy: "Sister Lakshmi",
    raisedAt: "Today · 08:10",
  },
  {
    id: "IND-444",
    department: "Pharmacy",
    priority: "Normal",
    items: "Insulin vials (Rapid)",
    quantity: "24",
    status: "Received",
    raisedBy: "Sister Anita",
    raisedAt: "2 days ago",
...
export const rooms: Room[] = [
  ...
  { id: "r18", number: "210", floor: "Second", category: "Special Twin", status: "Vacant" },
  {
    ...
    number: "211",
    floor: "Second",
    category: "Special Twin",
    status: "Occupied",
    patient: "N. Rangarajan",
  },
  {
    id: "r20",
    number: "301",
...
const initialHandovers: HandoverNote[] = [
  {
    ...
    department: "ICU",
    outgoing: "Sister Anita",
    incoming: "Sister Rekha",
    author: "Sister Anita",
    role: "sister",
...
export const queries: Query[] = [
  {
    ...
    raisedOn: "Today",
    status: "Open",
    question: "Clarify prior admission history for chronic condition.",
  },
  {
    id: "Q-2202",
    claim: "CL-9824",
    ...
    raisedOn: "Yesterday",
    status: "Responded",
    question: "Request for consultant notes and blood culture reports.",
  },
  {
    id: "Q-2203",
    claim: "CL-9822",
    ...
    raisedOn: "2 days ago",
    status: "Closed",
    question: "Confirm pre-authorisation coverage limits.",
  },
];
...
export const documents: DocRow[] = [
  {
    ...
    patient: "Ananya Sharma",
    claim: "CL-9821",
    document: "Pre-auth form, Discharge summary",
    uploadedAt: "2 h ago",
    by: "Neha Iyer",
  },
  {
    ...
    patient: "Rahul Menon",
    claim: "CL-9822",
    document: "Pre-auth, ECG, Angio report",
    uploadedAt: "just now",
    by: "Neha Iyer",
  },
  {
    ...
    patient: "Fatima Sheikh",
    claim: "CL-9824",
    document: "Consultant notes, Blood culture",
    uploadedAt: "1 d ago",
    by: "Neha Iyer",
  },
];
